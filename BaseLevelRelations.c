...
static int refresh_dir_list_(const char* root) {
    ...
    PARX_change_dims("PVM_DirFileList", n, 256);
...
void SetBaseLevelParam()
{
  ...
  if (PVM_DirSearchRoot[0]=='\0') {
	...
	(void)snprintf(PVM_DirSearchRoot, need, "%s", autoRoot);
