/* /opt/PV6.0.1/prog/curdir/qial/ParaVision/methods/src/qialUTE3D/initMeth.c */
void initMeth(void);
...
/* /opt/PV6.0.1/prog/curdir/qial/ParaVision/methods/src/qialUTE3D/backbone.c */
void backbone(void);
...
/* /opt/PV6.0.1/prog/curdir/qial/ParaVision/methods/src/qialUTE3D/BaseLevelRelations.c */
...
/* /opt/PV6.0.1/prog/curdir/qial/ParaVision/methods/src/qialUTE3D/RecoRelations.c */
void SetRecoParam(void);
void RecoDerive(void);
double RecoOptimiseMemory(int, int, int, int, double *);
/* /opt/PV6.0.1/prog/curdir/qial/ParaVision/methods/src/qialUTE3D/deriveVisu.c */
